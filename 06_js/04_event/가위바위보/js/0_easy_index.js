...
// 이벤트 핸들러에 등록 
scissorsBtn.addEventListener('click', () => buttonClickHnadler('scissors'))
rockBtn.addEventListener('click', () => buttonClickHnadler('rock'))
paperBtn.addEventListener('click', () => buttonClickHnadler('paper'))